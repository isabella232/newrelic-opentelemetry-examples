...
public class KafkaMetricRegistry {
  ...
  private static void registerProducerMetrics() {
    ...
    Set<String> tagKeys = Set.of("client-id");
  ...
  private static void registerProducerTopicMetrics() {
    ...
    Set<String> tagKeys = Set.of("client-id", "topic");
  ...
  private static void registerConsumerMetrics() {
    ...
    Set<String> tagKeys = Set.of("client-id", "topic", "partition");
